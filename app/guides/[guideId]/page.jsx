    ...
    return (
      <div className="bg-[#FEF8E7] min-h-[calc(100vh-136px)] py-12 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">Sorry, we couldn't find the guide you were looking for.</p>
  ...
  return (
    <div className="bg-[#FEF8E7] min-h-[calc(100vh-136px)] py-12 md:py-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-3xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-[#A13C20]">{guide.title}</h1>
